...
public:
    ...
    virtual void on_wakeup_error(std::int64_t error_us, std::int64_t compensation_us) noexcept = 0;
    virtual void on_busy_wait(std::uint64_t duration_us) noexcept = 0;
    virtual void
    on_frame_presented(const VideoSyncPresentationObservation& observation) noexcept = 0;
...
public:
    ...
    void on_frame_presented(const VideoSyncPresentationObservation&) noexcept override {}
